...
@Service("polishAgent")
@Slf4j
public class BitAgent4PolishImpl implements BitAgentService {
    ...
    public String createConversation() throws IOException {
        ...
        String requestBody = String.format(
                ...
                bitAgentConfig.getUserId(), bitAgentConfig.getAppKeyPolishAgent());
    ...
    public String queryBlocking(String conversationId, String query) throws IOException {
        ...
        if (responseNode.has("answer")) {
            ...
            log.warn("Blocking response missing 'answer' field: {}", responseBuilder);
            return "";
        }
    }
*/
    ...
    private Map<String, Object> buildRequestBody(String conversationId, String query, String mode) {
        ...
        map.put("AppKey", bitAgentConfig.getAppKeyPolishAgent()); // 从配置类获取
    ...
    private HttpURLConnection createConnection(String urlString, String method) throws IOException {
        ...
        connection.setRequestProperty("ApiKey", bitAgentConfig.getApiKeyPolishAgent()); // 注意 Header 是 ApiKey 还是 Authorization
